...
def should_send_alert(docker_image: Optional[str], expected_date: str) -> bool:
    """
    ...
    Args:
        ...
        expected_date: Expected date string in YYYYMMDD format
    ...
    def send_notification(
        ...
        try:
            ...
            if is_pd_test:
                ...
                if not should_send_alert(parsed_data["docker_image"], today_date):
